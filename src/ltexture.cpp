...
bool LTexture::loadFromFile( SDL_Renderer *sdl_renderer, std::string path)
{
...
bool LTexture::loadFromRenderedText( TTF_Font* gFont, SDL_Renderer *sdl_renderer, std::string textureText, SDL_Color textColor )
{
	//Get rid of preexisting texture
	free();
